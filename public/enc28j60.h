...
#define LD_ON HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_RESET); // LED Burayı o C13 diye girdi.
#define LD_OFF HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_SET);  // LED

//--------------------------------------------------
#define ENC28J60_MAXFRAME 512
#define MAC_ADDR   {0xC6,0x6E,0x1F,0xE8,0x47,0xE0}
//--------------------------------------------------
